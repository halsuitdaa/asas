            ...
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        ...
                        <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#" class="text-white">barocamp@gmail.com</a></small>
                    </div>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="../recipe/list.do" class="nav-item nav-link">캠핑레시피</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0" >
                                    ...
                                    <a href="../databoard/list.do" class="dropdown-item">공유자료실</a>  
                               
                                   
                                </div>
                                
                            </div>
                            <a href="../consumer/list.do" class="nav-item nav-link">고객센터</a>
                        </div>
                        <c:if test="${sessionScope.id!=null }">
