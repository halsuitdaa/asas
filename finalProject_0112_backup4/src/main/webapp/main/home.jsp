...
<body>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        <h4 class="mb-3 text-white">답답할땐 바로캠핑!</h4>
                        <h2 class="mb-5 display-3 text-white">캠핑장 & 캠핑용품</h2>
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="../img/screen.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                    <a href="../gocamping/list.do" class="btn px-4 py-2 text-white rounded">캠핑장</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="../img/screen.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="../store/store_main.do" class="btn px-4 py-2 text-white rounded">캠핑용품</a>
                                </div>
        ...
        <div class="container-fluid vesitable py-5">
            <div class="container py-5">
                ...
                <h4 class="text-primary">Campsite</h4>
                <h2 class="mb-0 text-center display-4">캠핑장</h2>
                </div>
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
             <div class="text-center">
             <h4 class="text-primary">Camping Supplies</h4>
            	<h2 class="text-center display-4">종류별 캠핑 용품</h2>
            	</div>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <h4 class="text-primary">Recipe</h4>
                    <h2 class="display-4">캠핑 요리레시피</h2>
		  ...
		  <div class="container-fluid banner bg-white my-5">
            <div class="container py-5">
                <div class="container" style="Width:1500px;height:500px;">
                 <h4 class="text-primary">Camping Safety Information</h4>
				  <h2>캠핑 안전 정보</h2>
				  <p>  
				  <div class="slide">
				   ...
				   <ul>
				      <li class="first">
				         <img src="../img/safe_camping.jpg" alt="안전한 캠핑">
				      </li>
				      <li>
				         <img src="../img/ready_camping.jpg" alt="캠핑 준비물">
				      </li>
				      <li>
				         <img src="../img/go_cam.jpg" alt="캠핑 기본 수칙">
				      </li>
				   </ul>
