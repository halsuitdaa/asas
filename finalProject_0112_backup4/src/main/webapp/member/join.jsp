  ...
  <!-- <div class="jumbotron" style="background-image: url('../img/rr.png'); background-size: cover;"> -->
    ...
    <form method="post" action="../member/join_ok.do" name="frm">
     ...
     <tr>
      ...
      <td width="85%" class="inline">
       <input type="text" size=15 class="input-sm" 
          readonly name="id" id="id" placeholder="아이디 입력">
     ...
     <tr>
      ...
      <td width="85%" class="inline">
       <input type="password" size=15 class="input-sm" name="pwd" id="pwd" placeholder="비밀번호 입력"> 
     ...
     <tr>
      ...
      <tr>
	      <th class="text-right" width="30%">이메일 주소</th>
	      <td width="85%">
     ...
     <tr>
      ...
      <input type="text" size=50 class="input-sm" name="addr2">
         ...
         <tr>
        <th class="text-right" width="30%">[필수]
        <br>개인정보 수집 및<br>정보이용 동의</th>
        <td width="85%">
        <span>개인정보 수집 및 정보이용 동의를 하지 않으면<br>
        원활한 사이트 이용이 불가할 수 있습니다.<br>
        1. 수집목적: 홈페이지 회원제 서비스 제공<br>
        2. 수집항목: 이름, 휴대전화번호<br>
        3. 보유 및 이용기간: 가입일로부터 탈퇴시까지</span>
         </td>
        </tr>
