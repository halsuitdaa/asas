...
<body>
    ...
    <div class="text-center"><p style="font-size: 30px;margin-left: 37px;">${year }년도 ${month }월</p></div>
    <div class="calendar" style="border: 1px solid; border-radius: 10px; overflow:hidden;height: 373px;">
       ...
       <tr class="danger">
         ...
         <c:forEach var="i" begin="1" end="${lastday }">  
             <c:if test="${i==1 }">
              ...
              <c:if test="${rday[i]==1}">
               <td class="text-center rdays" style="background-color:#81c408;color:white" data-year="${year }" data-month="${month }">${i }</td>
              </c:if>
              <c:if test="${rday[i]==0}">
  ...
  <br>
  <div class="calendarAre" style="width:398px;margin-left:21px;border-collapse:separate;border: 1px solid;border-radius: 10px;">
  <table class="reserveinfo" style="width: 397px;">
     <div class="checkinout">
     <tr>
        <td width="50%" class="text-center" style="font-size: 10px;border-right: 1px solid;"> 체크인 </td>
        <td width="50%" class="text-center" style="font-size: 10px;" > 체크아웃 </td>
     </tr>
     <tr style="border-bottom: 1px solid;">
        <td width="50%" id="room-check-in" class="text-center" style="border-right: 1px solid;">&nbsp;</td>
        <td width="50%" id="room-check-out" class="text-center">&nbsp;</td>
     </tr>
     <tr>
     <td colspan="2" class="text-center" style="font-size: 10px;">객실</td>
     </tr>
     <tr>
        <td colspan="2" class="text-center">
            <select id="roomoption" style="width: 300px;height: 25px;" class="text-center">
     ...
     <tr>
        <td colspan="2" class="text-center" style="font-size: 10px;">인원</td>
     </tr>
     <tr>
       <td colspan="2" class="text-center">
           <select id="person-option" style="width: 300px;height: 25px;" class="text-center">
   ...
   <tr>
   <td colspan="2" style="font-size: 10px;border-bottom: 1px solid;" >&nbsp;</td>
   </tr>
   <tr>
   <td>&nbsp;</td>
   </tr>
   <tr>
      <td colspan="2">
         <a id="reserveLink" href="">
              <div class="btn btn-md btn-primary" style="width: 300px;height: 50px;">
                 <p style="margin-top: 5px;color: white;">예약하기</p>
              </div>
           </a>
      </td>
   </tr>
