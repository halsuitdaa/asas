...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('reserve_person').value = checkinperson;
       ...
       if ( rsp.success ) {
         ...
         $.ajax({
          ...
          success:function(result)
          {
             ...
             if(result=='yes')
             {
                location.href="../gocamping/reserve_finish.do?campingno="+${campingvo.mno}
             }
             else
             {
                alert("구매가 완료되었습니다")
...
<body>
   ...
   <td width="50%">
      <div class="left-reserve">
           <table>
              <tr>
                 <td><p style="font-size: 25px; color:black;">예약자 정보</h4></td>
              </tr>
              <tr>
                 <td>예약자 이름</td>
              </tr>
                 <c:if test="${sessionScope.id!=null }">
                    <tr>
                         <td><input type="text" size=50 class="input-sm" name="id" id="reserveid" style="height: 42px;border-radius: 5px;padding-left: 10px;border-color: rgb(204,204,204);" value="${sessionScope.name }"><!-- 읽기만 :readonly --></td>
                    </tr>
                    <tr>
                        <td>휴대폰번호</td>
                   </tr>
                    <tr>
                      <td><input type="text" size=15 class="input-sm" name="phone" id="phone" style="height: 42px;border-radius: 5px;padding-left: 10px;border-color: rgb(204,204,204);" value="${sessionScope.phone }"></td>
                    </tr>
                    <tr>
                        <td>예약인원</td>
                     </tr>
                     <tr>
                      <td><input type="text" size=15 id="reserve_person" style="height: 42px;border-radius: 5px;padding-left: 10px;border-color: rgb(204,204,204);" value="" readonly></td>
                    </tr>
                    <!-- <tr>
                     <td>요청사항</td>
                    </tr>
                 ...
                 <c:if test="${sessionScope.id==null }">
                    <tr>
                         <td><input type="text" size=50 class="input-sm" name="id" id="reserveid" style="height: 42px;border-radius: 5px;border-color: rgb(204,204,204);" readonly><!-- 읽기만 :readonly --></td>
                    </tr>
                    <tr>
                        <td>휴대폰번호</td>
                   </tr>
                    <tr>
                      <td><input type="text" size=15 class="input-sm" name="phone" id="phone" style="height: 42px;border-radius: 5px;border-color: rgb(204,204,204);" readonly></td>
                    </tr>
                    <tr>
                        <td>예약인원</td>
                     </tr>
         ...
         <hr>
           <table>
             <tr>
                <td><p style="font-size: 25px; color:black;">결제수단</p></td>
             </tr>
      ...
      <div style="border-radius: 10px; border: 1px solid;padding: 10px;margin-bottom: 20px;border-color: rgb(204,204,204);">
         <p style="font-size: 20px; color:black;">캠핑장 정보</p>
         <table class="table" style=" width: 320px; font-size: 13px;">
         <tr>
              <th colspan="2" id="reserve_title" style="font-size: 15px;border: none;">${campingvo.title }</th>
           </tr>
           <tr>
              <td colspan="2">
           ...
           <tr>
              <th style="width:40%;border: none;">객실</th>
               <td style="width:60%;border: none;">${roomvo.roomname }</td>
           </tr>
            <tr>
               <th style="width:40%;border: none;">선택한 날짜</th>
               <td style="width:60%;border: none;"><span id="reserve_room_checkin" readonly></span> ~ <span id="reserve_room_checkout" readonly></span></td>
           </tr>
           <tr>
              <th style="width: 40%;border: none;">기준인원</th>
               <td style="width:60%;border: none;">${roomvo.roompersonnel } / ${roomvo.roommaxpersonnel }(추가요금)</td>
            </tr>
           
           </table>
         </div>
           <table class="finalpay" style="border: 1px solid; border-radius: 10px; border-collapse:separate;padding: 10px; width: 342px;border-color: rgb(204,204,204);">
              <tr>
                 <td>
                    <table style="width: 300px;">
                       <tr>
                          <td colspan="3"><p style="font-size: 25px; color:black;">결제금액</p></td>
                       </tr>
                       <tr>
                    ...
                    <c:if test="${sessionScope.id!=null }">
                       <td colspan="2"><div class="btn btn-md btn-primary" style="width: 250px; height:50px; padding-top: 10px; " onclick="requestPay()">결제하기</div></td>
                    </c:if>
                    <c:if test="${sessionScope.id==null }">
                       <td colspan="2"><div class="btn btn-md btn-primary" style="width: 250px; height:50px; background-color: gray;border-color:gray; padding-top: 10px;color:white;">로그인 후 이용가능</div></td>
                    </c:if>
                    </tr>
                    </td>
                 </tr>
