...
public class GoCampingVO {
	...
	private int gcrnoo,gocampingno,roomno;
	
	private String roomname,roomprice, roompersonnel, roommaxpersonnel, checkin, checkout, room1, room2, room3, room4, room5, room6, room7, room8, room9, room10; 
	...
	public int getGocampingno() {
		return gocampingno;
	}
	public void setGocampingno(int gocampingno) {
		this.gocampingno = gocampingno;
	}
	...
	public String getRoommaxpersonnel() {
		return roommaxpersonnel;
	}
	public void setRoommaxpersonnel(String roommaxpersonnel) {
		this.roommaxpersonnel = roommaxpersonnel;
	}
	...
	private int ino;
	private String notice,info,roominfo,personnel,service,bbq,cancle,etc;
	...
	public int getGcrnoo() {
		return gcrnoo;
	}
	public void setGcrnoo(int gcrnoo) {
		this.gcrnoo = gcrnoo;
	}
